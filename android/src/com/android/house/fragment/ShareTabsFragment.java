...
public class ShareTabsFragment extends BaseFragment implements OnClickListener{
	...
	private void initView(View tabsView){
		shareWX = (LinearLayout)tabsView.findViewById(R.id.share_weixin);
		shareTX = (LinearLayout)tabsView.findViewById(R.id.share_tx_weibo);
		shareSina = (LinearLayout)tabsView.findViewById(R.id.share_sina_weibo);
		shareContacts = (LinearLayout)tabsView.findViewById(R.id.share_contacts);
