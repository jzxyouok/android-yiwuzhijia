...
import com.android.house.adapter.HouseDetailAdapter;
import com.android.house.adapter.HouseDetailHeaderAdapter;
				...
				if(imageUrls.size()!=0)
				{
					...
					innerListView.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent,
							...
							Log.d("mao", "点击出大图");
//							bigImagePopup.showBigImage(imageUrls.get(position), price,mMapFragment.getView().getWidth(),mMapFragment.getView().getWidth());
	...
	private void initView(){
		...
		bigImagePopup=new BigImagePopup();
		bigImagePopup.initView(this);
	...
	private void initData(House house)
	{
		...
		fee.setText(fee.getText()+(house.getProperty_price()));
		this.house_position.setText(house_position.getText()+house.getArea_name()+house.getHouse_address());
		this.plotRatio.setText(plotRatio.getText()+house.getFloor_area_ratio());
		this.greeningRate.setText(greeningRate.getText()+house.getGreen_rate());
	...
	public void onClick(View v) {
		switch(v.getId()){
		case R.layout.item_house_detail_dialog:
			break;
