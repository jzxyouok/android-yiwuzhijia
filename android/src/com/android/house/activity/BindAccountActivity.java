...
//			
//			if (code.equals("")) {
//				Toast.makeText(BindAccountActivity.this, "请输入验证码",
//						Toast.LENGTH_SHORT).show();
//			} else if (code.length() <= 5) {
//				Toast.makeText(BindAccountActivity.this, "请输入6位验证码",
//						Toast.LENGTH_SHORT).show();
//			} else {
	...
	public void OnMessageResponse(String url, JSONObject jo, AjaxStatus status)
		...
		if (url.endsWith(ProtocolConst.BIND_ACCOUNT)) {
			...
			if (jo.optString("status").equals("200")) {
				Toast.makeText(this, "验证码获取成功，请留意您的短信哦，亲~", Toast.LENGTH_LONG)
						.show();
				timer.start();
			} else {
				Toast.makeText(this, jo.optString("msg"), Toast.LENGTH_LONG)
						.show();
			}
		}
