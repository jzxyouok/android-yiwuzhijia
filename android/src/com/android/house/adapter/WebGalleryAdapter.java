...
public class WebGalleryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
        	...
        	convertView = LayoutInflater.from(context).inflate(R.layout.item_web_gallery_img, null);
        	viewHolder.webImageView = (WebImageView)convertView.findViewById(R.id.web_gallery_img);
        ...
        viewHolder.webImageView.setImageUrl(imageUrl);
