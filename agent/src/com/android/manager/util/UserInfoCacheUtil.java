...
public class UserInfoCacheUtil {
	...
	public static CacheInfo getCacheInfo(Context context)
	{
		...
		cacheInfo.setSex(sharedPreferenced.getInt("sex", -1));
		cacheInfo.setStype(sharedPreferenced.getInt("stype", -1));
		return cacheInfo;
	}
	...
	public static void saveCacheInfo(Context context,CacheInfo cacheInfo)
	{
		...
		editor.putInt("stype",cacheInfo.getStype());
		editor.putInt("sex", cacheInfo.getSex());
		editor.commit();
