...
public class CropImage
{
    ...
    public static final File FILE_LOCAL = new File(FILE_SDCARD,AppConstants.APP_DIR+File.separator+AppConstants.IMAGE_DIR+File.separator+AppConstants.HEAD_SHOT);
...
//        Rect dr = mCrop.mDrawRect;
    ...
    public String saveToLocal(Bitmap bm,String user_phone)
    {
    	String path = FILE_LOCAL.getAbsolutePath()+File.separator+"headshot_"+user_phone+".png";
    	File file=new File(path);
    	Log.d("mao","用户头像保存地址"+path);
    	try
		{
    		if(!file.exists())
    		{
